...
class Hrecord extends StatefulWidget {
  const Hrecord({Key? key}) : super(key: key);

  @override
  State<Hrecord> createState() => _HgeneralState();
}

class _HgeneralState extends State<Hrecord> {
